...
dat_inside<- readRDS(file = "dat_inside.rds")
tab_inside<-readRDS(file = "tab_inside.rds")
dat_buffer<-readRDS(file = "dat_buffer.rds")
tab_buffer<-readRDS(file = "tab_buffer.rds")
